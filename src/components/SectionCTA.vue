...
.resource-title { font-size: 0.875rem; font-weight: 600; color: var(--heading-color); margin-bottom: 2px; }
...
.form-header h3 { font-size: 1.3rem; font-weight: 700; color: var(--heading-color); margin-bottom: 6px; }
...
.success-card h3 { font-size: 1.4rem; font-weight: 700; color: var(--heading-color); }
